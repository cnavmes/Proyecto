        ...
        >
          <div class="w-full bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
            ...
            <div class="text-center mb-8">
              ...
              <div class="text-surface-50 text-3xl font-medium mb-4">
                Bienvenido a Un Mar de Lúpulo
              </div>
            ...
            <div>
              ...
              <input
                ...
                class="w-full md:w-[30rem] mb-8 bg-surface-800 text-surface-50"
                [(ngModel)]="email"
              />
              ...
              <p-password
                ...
                [toggleMask]="true"
                styleClass="mb-4 w-full bg-surface-800 text-surface-50"
                [fluid]="true"
                [feedback]="false"
              ></p-password>
  ...
  onSubmit(): void {
    ...
    this.authService.login(this.email, this.password).subscribe({
      next: () => {
        ...
        this.router.navigate([rol === 'ADMIN' ? '/admin-panel' : '/usuario-panel']);
      },
      error: () => {
